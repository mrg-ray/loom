...
func TestLoadMigrations(t *testing.T) {
	...
	// Verify we have all 20 migrations.
	...
	// 000019_context_compilation, then 000020_tool_exec_admission_decision.
	assert.Len(t, migrations, 20, "should have 20 migration versions")
